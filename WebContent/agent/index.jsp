...
<html>
	...
	<body>
		...
		<div class='container'>
				...
				<img src="../images/agents.jpeg" style='width:100%;height:300pt;'>
					...
					<center><table style='margin-top:30pt;'>
							<form method='get' action='index.jsp'>
								<tr>
									<td colspan='4'>
									<center><input type='text' placeholder="e.g umair" name='search' style='width:200pt;height:20pt;'></center><br>
									</td>
								</tr>
								<tr>
									<td colspan='4'>
			...
			<div class='search_result' style='padding-left:20pt;'>
				<%if (request.getParameter("search_buttons") != null)
    			{
					BannerManagementJsp.GetBanner(search); 
    			}	
    			else{ %>
				<%=BannerManagementJsp.GetBanner() %>							
				<%} %>
			</div><!-- search_result -->
		</div><!-- container -->
