...
<html>
	...
	<body>
		...
		<div class='container' style='height:400pt;'>
			<div class='login_area' style='height:400pt;'>
				<%=message %>
				<div class='login' style='margin-top:84pt;margin-left:130pt;'>
				<div class="form-style-2">
				
				
					<form action='LoginPath' method='post' name='login' style='margin-left:-25pt;'>
						<table>
							<col width="130">
							<tr>
    ...
    onchange="try{setCustomValidity('')}catch(e){}" /></label></td>
							...
							<tr>
								<td><a href="forget.jsp" style='text-decoration:underline; font-size:9pt;'>Forget Password</a></td>
							</tr>
							<tr>
